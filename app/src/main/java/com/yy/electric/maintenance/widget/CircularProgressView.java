package com.yy.electric.maintenance.widget;
...
public class CircularProgressView extends BaseView {
  ...
  private final float mMaxProgress = 100;
  ...
  private float mStartAngleProgress = 0;
  ...
  private void drawArc(Canvas canvas) {
    canvas.drawArc(mArcLeft + paddingStart, mArcTop + paddingTop,
            ...
            -90f, 360, false, mDefaultProgressPaint);
    canvas.drawArc(mArcLeft + paddingStart, mArcTop + paddingTop,
            mArcRight - paddingEnd, mArcBottom - paddingBottom,
            -90f,
            mStartAngleProgress * 360 / mMaxProgress, false, mProgressPaint);
  }
